...
[v,ev,ea,n] =  anpi_erf(x,c)        %Llamada a la funcion y retorno de parametros

%%%%%%%%%%%%%%%%%%%%%%%%%Problema 2%%%%%%%%%%%%%%%%%%%%%%%%%%%

%Problema 2 en el pdf
...
disp(" de la precision simple y double. Ambas tienen un delta diferente");
